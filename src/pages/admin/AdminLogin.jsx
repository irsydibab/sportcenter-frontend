...
import { Lock, Mail, ArrowRight, AlertCircle, ShieldCheck, ArrowLeft, Eye, EyeOff } from 'lucide-react';
        ...
        <div className="min-h-screen bg-[#f8faf9] font-sans antialiased flex items-center justify-center p-4">
            ...
            <div className="w-full max-w-md bg-white rounded-3xl shadow-xl border border-slate-100 overflow-hidden">
                ...
                <form onSubmit={handleLogin} className="p-7 space-y-4">
                    ...
                    >
                        {loading ? 'Memproses Authentikasi...' : 'Masuk Dashboard'} <ArrowRight className="w-4 h-4" />
                    </button>
